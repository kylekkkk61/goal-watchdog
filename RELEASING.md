...
- [x] Run `./scripts/check.sh` on the minimum supported macOS version and the current macOS version. CI covers macOS 14; the current macOS check is also required before tagging.
